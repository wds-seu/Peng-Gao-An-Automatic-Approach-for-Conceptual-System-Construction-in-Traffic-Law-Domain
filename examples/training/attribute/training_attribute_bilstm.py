...
model_save_path = 'output/training_attribute_bilstm-'+datetime.now().strftime("%Y-%m-%d_%H-%M-%S")


# Map tokens to traditional word embeddings like GloVe
word_embedding_model = models.WordEmbeddings.from_text_file('../hypernymy/datasets/chinese.w2c.300d.iter5')
...
logging.info("Read attribute train dataset")
...
logging.info("Read attribute dev dataset")
evaluator = BinaryHypernymyClassificationEvaluator.from_input_examples(dev_samples, name='attribute-dev')
...
evaluator = BinaryHypernymyClassificationEvaluator.from_input_examples(test_samples, name='attribute-test')
